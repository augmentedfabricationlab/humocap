...
1. Fork `the repository <https://github.com/augmentedfabricationlab/humocap>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/humocap/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/humocap/issues>`_. If you are proposing a feature:
